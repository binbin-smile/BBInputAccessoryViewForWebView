#
#  Be sure to run `pod spec lint BBInputAccessoryViewForWebView.podspec' to ensure this is a
...
UiWebView自定义InputAccessoryViewForWebView::BBInputAccessoryViewForWebView.
  ...
  s.author             = { "Yibin" => "1357494268@qq.com" }
  # Or just: s.author    = "Yibin"
  # s.authors            = { "Yibin" => "1357494268@qq.com" }
  # s.social_media_url   = "http://twitter.com/Yibin"
  ...
  s.source       = { :git => "https://github.com/LiuYibin/BBInputAccessoryViewForWebView.git", :tag => "#{s.version}" }
